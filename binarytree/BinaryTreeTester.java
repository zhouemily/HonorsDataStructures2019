...
public class BinaryTreeTester
{
    ...
    private void basicTest()
    {
        ...
        if (util.maxDepth(t) == randomDepth) 
        {
            System.out.println ("maxDepth works");
        }
        else 
        {
            System.out.println ("maxDepth no work");
        }
        TreeNode copyTree = t;
        ...
        {
            System.out.println ("SameShape no work");
        }
        ...
        {
            System.out.println ("Copy no work");
        }
        System.out.println ("Leftmost node from root is " + 
            util.leftmost (t));
        System.out.println ("Rightmost node from root is " +
            util.rightmost (t));
        System.out.println ("Total number of nodes is " + 
            util.countNodes (t));
        System.out.println ("Total number of leaves is " +
            util.countLeaves (t));
    ...
    private void morseTest()
    {
        ...
        TreeDisplay display = new TreeDisplay();
        BinaryTreeTester morseTester = new MorseBinaryTreeTester();
        display.setTester (morseTester);
        TreeUtil util = new TreeUtil();
        ...
        String decoded1 = util.decodeMorse (decodingTree, 
                "... --- ...", display);
        System.out.println ("\nIt should have printed: " + decoded1 + "\n");

        System.out.println ("Let's decode .- -- . .-. .. -.- ..- ....");
        String decoded2 = util.decodeMorse (decodingTree, 
                ".- -- . .-. .. -.- ..- ....", display);
        System.out.println ("\nIt should have printed: " + decoded2 + "\n");

        System.out.println ("Let's decode -.-. .... .-. .. ... - -- .- ...");
        String decoded3 = util.decodeMorse (decodingTree, 
                "-.-. .... .-. .. ... - -- .- ...", display);
     ...
     */
    private void userMorse(TreeUtil util, 
    TreeNode decodingTree, TreeDisplay display)
    {
        ...
        {
            System.out.println ("\fType valid morse code. "
                + "The tester will break if code is not valid.\n"
    ...
    /**
     * Tests the TreeUtil methods to save a Binary Tree
     * to file and reconstruct it by reading back the contents.
     */
    ...
    public void test()
    {
        ...
        while (true)
        {
            ...
            if (response == 4) 
            { 
                System.out.print("\fYou win!"); System.exit(1);
            }
    ...
    /**
     * Entry method to run the tester.
     * 
     * @param args command line arguments, not expected any
     */
...
/**
 * A subclass of BinaryTreeTester for morseTest()
 * to override the sendValue() display callback method.
 * 
 * @author Emily Zhou
 * @version 01-14-2019
 */
class MorseBinaryTreeTester extends BinaryTreeTester
{
    /**
     * Called by the display object to send back
     * the node value when a node is visited.
     * 
     * @param value the value passed that is printed out
     */
    @Override
